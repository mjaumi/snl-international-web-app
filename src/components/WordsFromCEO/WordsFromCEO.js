...
import aboutCEO1 from '../../assets/images/about-ceo-1.JPG';
import aboutCEO2 from '../../assets/images/about-ceo-1.JPG';
            ...
            <div className='w-[95%] md:w-[90%] mx-auto'>
                ...
                <div className='flex flex-col xl:flex-row'>
                    <div className='w-full xl:w-1/2 h-[40vh] xl:h-[60vh] flex justify-center mt-10'>
                        <SectionImageDiv image1={aboutCEO1} image2={aboutCEO2} />
                    </div>
