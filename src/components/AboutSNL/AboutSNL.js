        ...
        <section className='w-[95%] md:w-[90%] mx-auto py-10'>
            ...
            <div className='flex flex-col xl:flex-row'>
                ...
                <div className='w-full xl:w-1/2 flex items-center'>
                    <p className='text-base lg:text-lg text-center xl:text-left mt-10 xl:mt-0'>We can proudly say that Bangladesh is the home of Jute and it is an honor for us to work to elevate the reputation of this natural Golden fiber. Bangladeshi Jute is known as the “Golden Fiber” due to the high quality. Because of the superior fiber quality of Bangladeshi Jute, it has dominated the global market for so long.
