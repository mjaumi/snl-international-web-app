...
const SectionImageDiv = ({ image, altText }) => {
    return (
        <div className='relative h-fit w-fit p-5'>
            <img className='h-[200px] w-[200px] md:h-[300px] md:w-[300px] 2xl:h-[400px] 2xl:w-[400px] shadow-snl' title={altText} height={452} width={390} src={image} loading='lazy' alt={altText} />
