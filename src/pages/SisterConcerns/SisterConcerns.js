...
const SisterConcerns = () => {
    ...
    return (
        <section>
            <PageTitle title={'Our Sister Concerns'} description={'Sister concerns page of SNL International. Here, user can get to know about sister concerns of SNL International.'} canonical={process.env.NODE_ENV === 'development' ? 'http://localhost:3000/sister-concerns' : 'http://www.snlbd.com/sister-concerns'} />
